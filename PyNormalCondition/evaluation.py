from fft_extract import extract_features_from_adc, get_features_row
import serial
import os
import time
...
def determine_output(label):
    if label == 0:
        return "coin at distance of 10cm and height of 10cm"
    elif label == 1:
        return "coin at distance of 30cm and height of 10cm"
    elif label == 2:
        return "coin at distance of 10cm and height of 30cm"
    elif label == 3:
        return "coin at distance of 30cm and height of 30cm"
    elif label == 4:
        return "eraser at distance of 10cm and height of 10cm"
    elif label == 5:
        return "eraser at distance of 30cm and height of 10cm"
    elif label == 6:
        return "eraser at distance of 10cm and height of 30cm"
    elif label == 7:
        return "eraser at distance of 30cm and height of 30cm"
...
def predict(filename):
    ...
    scaler: StandardScaler = joblib.load("./MLP_training/scaler.joblib")
    ...
    # print(model.device)
    model.load_state_dict(torch.load("./MLP_training/best_model.pth", map_location="cpu"))
    model.eval()
    with torch.no_grad():
